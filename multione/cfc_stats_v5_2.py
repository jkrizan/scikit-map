...
from cfc_v5_2 import CfcLearner_v5, ArcoV2DatasetV3
import cfc_sample
...
#%%
    ...
    df.to_pickle("/mnt/nibble/gen_cog/arcov2/cfc-v5.2-e79_observed_vs_predicted.pickle")
    # b=0
