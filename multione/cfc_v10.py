...
class CfcModelV9(nn.Module):
    def __init__(self, 
        ...
        super(CfcModelV9, self).__init__()
...
class CfcLearnerV9(pl.LightningModule):
    def __init__(self, fn_zarr, years, 
        ...
        super(CfcLearnerV9, self).__init__()
        self.to(dtype)
        ...
        self.model = CfcModelV9(input_size=input_size,
    ...
    def setup(self, stage=None):        
        ...
        if self.hparams['debug']:
            ...
            dataset = ArcoV2DatasetV9( self.hparams['fn_zarr'],
                                       years=self.hparams['years'],
                                       sequence_length=self.hparams['sequence_length'],
                                       indices=self.hparams['indices'],
...
def playground():
    ...
    indices=['ndvi'] # 
    percent_pixels = 0.1
    ds = ArcoV2DatasetV9(fn_zarr, years, sequence_length, indices, 
    ...
    dl = MemoryDataLoader(ds, batch_size=4096, indexes=None, cache_length=10)
