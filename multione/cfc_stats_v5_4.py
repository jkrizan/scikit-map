...
fld_out = Path('/mnt/nibble/gen_cog/arcov2/prd_cfcv5.4')
fld_out.mkdir(exist_ok=True, parents=True)
fn_ckpt = Path('/mnt/nibble/gen_cog/arcov2/cfc_v5.4-e_298.ckpt')
fld_gifs = Path('/mnt/nibble/gen_cog/arcov2/gifs_v5.4')
